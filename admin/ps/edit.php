<?php
    ...
    $sql = "SELECT * FROM playstation WHERE id_ps =  ?";
        ...
        <div class="card-header text-white bg-primary">
            <h4 class="card-title">
                ...
                <div class="float-right">
                    <a class="btn btn-warning" href="PS.php" role="button">Kembali</a>
                </div>
            </h4>
        </div>
        <div class="card-body">
                ...
                <form method="post" action="proses.php?aksi=edit&id=<?= $id;?>" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="form-group row">
                                <label class="col-sm-3">Jenis Game</label>
                                <select class="form-control col-sm-9" name="j_game">
                                    <option value="" disabled selected>Pilih Jenis PS</option>
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3">Jenis PS</label>
                                <input type="text" class="form-control col-sm-9" name="j_ps" placeholder="Isi jenis ps">
                            </div>
