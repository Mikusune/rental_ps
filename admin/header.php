...
<html lang="en">
  <head>
    <title><?php echo $title_web;?> | rental ps</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #333;">
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavId">
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                ...
                <li class="nav-item <?php if($title_web == 'Daftar PS'){ echo 'active';}?>
                <?php if($title_web == 'Tambah ps'){ echo 'active';}?>
                <?php if($title_web == 'Edit ps'){ echo 'active';}?>">
                    <a class="nav-link" href="<?php echo $url;?>admin/ps/PS.php">Daftar PS</a>
                </li>
