<?php
    ...
    $hasil = $koneksi->query("SELECT * FROM playstation WHERE id_ps = '$id'")->fetch();
?>
...
<div class="row">
    ...
    <div class="col-sm-6">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title"><?php echo $hasil['j_ps'];?></h4>
                <p class="card-text">
                    Deskripsi :
                ...
                <hr/>
                <center>
                    <a href="booking.php?id=<?php echo $hasil['id_ps'];?>" class="btn btn-success">Booking now!</a>
